...
class StudiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create study" do
    assert_difference('Study.count') do
      post studies_url, params: { study: { course: @study.course, institute: @study.institute, years: @study.years } }
    end
  ...
  test "should update study" do
    patch study_url(@study), params: { study: { courses: @study.courses, institute: @study.institute, years: @study.years } }
